...
<div class="mainwrapper">
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li <%if(uri.indexOf("stuhomepage")!=-1) out.print("class=\"active\""); %>><a href="teacherhomepage"><span class="iconfa-laptop"></span> 主页</a></li>         
                <li <%if(uri.indexOf("stuappealman")!=-1) out.print("class=\"active\""); %>><a href="teacherappealman"><span class="iconfa-envelope"></span> 申诉处理</a></li>
                <li <%if(uri.indexOf("stucalendar")!=-1) out.print("class=\"active\""); %>><a href="showteachercalendar"><span class="iconfa-calendar"></span>日历</a></li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="teachersendmail.html">申诉处理/发件箱</a></li>
             ...
             <div class="messagepanel">
                    ...
                    <div class="messagemenu">
                        <ul>
                            ...
                            <li ><a href="teacherappealman.html"><span class="iconfa-inbox"></span> 收件箱</a></li>
                            <li class="active"><a href="teachersendmail.html"><span class="iconfa-plane"></span> 发件箱</a></li>
